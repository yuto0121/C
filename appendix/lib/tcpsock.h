...
#define    TCP_TIMED_OUT            6   // socket wait timed out
...
/**
 * Acts similarly to tcp_receive(3), but additionally takes a timeout parameter that decides how long to wait for a packet
 * before timing out.
 ...
 * If the connection times out before a packet is received returns TCP_TIMED_OUT
